...
--             memberManager:SetPos(8, generalConfig:GetTall() + 12)
--             memberManager:SetSize(generalConfig:GetWide(), editor:GetTall() - generalConfig:GetTall() - 16)
...
--             searchBtn:SetPos(memberManager:GetWide() - addMember:GetWide() - searchBtn:GetWide() - 20, 2)
--             searchBtn:SetText("")
--             searchBtn:SetToolTip("Search for member in rank")
--             searchBtn:SetColor(addMember:GetColor())

--             local searchInput = vgui.Create("NadminTextEntry", memberManager)
--             searchInput:SetSize(memberManager:GetWide() / 2, 24)
--             searchInput:SetPos(memberManager:GetWide() - addMember:GetWide() - searchBtn:GetWide() - searchInput:GetWide() - 24, 2)
